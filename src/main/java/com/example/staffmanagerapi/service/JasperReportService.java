...
public class JasperReportService {
    ...
    public <T> byte[] generateReport(String reportClassPathLocation, List<T> data) {
        ...
        try {
            ...
            Resource reportResource = new ClassPathResource(reportClassPathLocation); // example : "reports/cra.jrxml"
            InputStream reportInputStream = reportResource.getInputStream();
            // Set custom font directory (the folder where you placed the Roboto font files)
            String customFontDirectory = "fonts/";
            // Compile the Jasper Report with the custom font
    ...
    public Map<String, Object> generateReportParameters() throws IOException {
